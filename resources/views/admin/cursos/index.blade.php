...
@section('titulo','Produtos/Serviços')
...
@section('conteudo')
  <div class="container">
    ...
    <div class="row">
      <a class="btn blue" href="{{ route('admin.cursos.adicionar') }}">Adicionar Produto</a>
      <a class="btn green" href="{{route('admin.ordens')}}">Adicionar O.S</a>
    </div>
